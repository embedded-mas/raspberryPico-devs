...
{ 
  ...
  if(att == 1){
    if(buff == 0){
      communication.startBelief("emptyB");
    }
    else{
      communication.startBelief("fullB");
    }
    communication.beliefAdd(b);
    communication.endBelief();
    if(rack == 0){
      communication.startBelief("emptyR");
    }
    else{
      communication.startBelief("fullR");
    }
    communication.beliefAdd(r);
    communication.endBelief();
    if(mov == 0){
      communication.startBelief("stop");
    }
    else{
      communication.startBelief("play");
    }
    communication.beliefAdd(m);
    communication.endBelief();
